...
bool MenuState::onEnter() {
	...
	GameObject* button1 = new MenuButton(new LoaderParams(200, 100, 400, 100, "playButton"), s_menuToPlay);
	GameObject* button2 = new MenuButton(new LoaderParams(200, 300, 400, 100, "exitButton"), s_exitFromMenu);
